...
| 4 | “把下载缓存里的 PDF 附到 Zotero，完成后再移动到科研目录。” | Reject the cache path; require an existing approved final absolute D-drive path before linking; do not attach then move. |
